<template>
  <div class="list-header">
    <PageTitle :items="breadcrumbs" title="Create New User" />
  </div>
  <div class="border-header" />
  <div class="form-sections enabled">
    <div class="form-section">
      <div class="form-header">User Information</div>
      <el-form label-position="top" :model="form" :rules="formRules" v-loading="loading" ref="formRef"
        require-asterisk-position="right">
        <div class="form-content">
          <UploadProfile label="Profile" style="margin-bottom: 15px" :width="100" :isRequired="false" :max-size="150"
            :aspectRadio="'1/1'" :resolution-height="256" :resolution-width="256" :preview-url="form.avatar" />
          <el-row :gutter="24">
            <el-col :span="8">
              <el-form-item prop="firstName" label="First Name">
                <el-input v-model="form.firstName" placeholder="Input First Name" maxlength="50" show-word-limit
                  size="large" />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="8">
              <el-form-item prop="lastName" label="Last Name">
                <el-input v-model="form.lastName" placeholder="Input Last Name" maxlength="50" show-word-limit
                  size="large" />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="8">
              <el-form-item label="Gender" prop="gender" class="radio-btn">
                <el-radio-group style="width: 100%" v-model="form.gender" size="large">
                  <el-radio v-for="(gender, index) in Gender" :key="index" :label="gender.value" border
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item prop="email" label="Email">
                <el-input v-model="form.email" placeholder="Input Email" maxlength="50" show-word-limit size="large" />
              </el-form-item>
            </el-col>

            <el-col :span="8">
              <el-form-item prop="phoneNumber" label="Phone Number">
                <el-input v-model="form.phoneNumber" placeholder="Input Phone Number" maxlength="20" show-word-limit
                  size="large" />
              </el-form-item>
            </el-col>
            ...
            <el-col :span="8">
              <el-form-item prop="cidNumber" label="ID Card Number">
                <el-input v-model="form.cidNumber" placeholder="Input ID Card Number" maxlength="20" show-word-limit
                  size="large" />
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="Role" prop="role">
                <el-select v-model="form.role" placeholder="Select Role" size="large" filterable>
                  <el-option v-for="(role, index) in Roles" :key="index" :value="role.value"
            ...
            <el-col :span="8">
              <el-form-item label="Department Name" prop="deptName">
                <el-input maxlength="50" show-word-limit size="large" v-model="form.deptName"
            ...
            <el-col :span="8">
              <el-form-item label="Staff ID" prop="staffID">
                <el-input v-model="form.staffId" maxlength="50" show-word-limit size="large"
          ...
          <div class="buttons">
            ...
            <el-button type="primary" :icon="loading ? RefreshLeft : ''" size="large" @click="submit">Save</el-button>
          </div>
        </div>
      </el-form>
    </div>
